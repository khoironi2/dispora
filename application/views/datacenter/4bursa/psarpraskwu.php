                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <ul class="nav nav-bold nav-pills">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#kt_tab_pane_7_3">Pelatihan Keterampilan</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#kt_tab_pane_7_4">Apresiasi & Penghargaan</a>
                                </li>
                            </ul>
                        </div>
                    </div>
