                    ...
                    <div class="card-header">
                        ...
                        <div class="card-toolbar">
                            <ul class="nav nav-bold nav-pills">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#kt_tab_pane_7_1">SELEKSI KEWIRAUSAHAAN</a>
                                </li>
                                <li class="nav-item">
                                                ...
                                                <div class="card-body pt-4">
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            ...
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/Psarpraskwu/kwup/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">DAFTAR</a>
                                                            <?php endif; ?>
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            <?php if (!$this->session->userdata('email')) : ?>
                                                                <a href="#" onclick="return confirm('Maaf anda belum login');" class="btn btn-primary font-weight-bolder mr-2"><span>DAFTAR</span></a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/Psarpraskwu/pelopor/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">DAFTAR</a>
                                                            <?php endif; ?>
                                                        <?php } elseif ($key['status_selesai'] == 2) { ?>
                                                            <a class="tutup" href="#" class="btn btn-light-info font-weight-bolder mr-2">BERJALAN</a>
                                                        <?php } elseif ($key['status_selesai'] == 3) { ?>
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            <?php if (!$this->session->userdata('email')) : ?>
                                                                <a href="#" onclick="return confirm('Maaf anda belum login');" class="btn btn-primary font-weight-bolder mr-2"><span>DAFTAR</span></a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/Psarpraskwu/papn/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">DAFTAR</a>
                                                            <?php endif; ?>
                                                        <?php } elseif ($key['status_selesai'] == 2) { ?>
                                                            <a class="tutup" href="#" class="btn btn-light-info font-weight-bolder mr-2">BERJALAN</a>
                                                        <?php } elseif ($key['status_selesai'] == 3) { ?>
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            <?php if (!$this->session->userdata('email')) : ?>
                                                                <a href="#" onclick="return confirm('Maaf anda belum login');" class="btn btn-primary font-weight-bolder mr-2"><span>DAFTAR</span></a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/Psarpraskwu/lbb/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">DAFTAR</a>
                                                            <?php endif; ?>
                                                        <?php } elseif ($key['status_selesai'] == 2) { ?>
                                                            <a class="tutup" href="#" class="btn btn-light-info font-weight-bolder mr-2">BERJALAN</a>
                                                        <?php } elseif ($key['status_selesai'] == 3) { ?>
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            <?php if (!$this->session->userdata('email')) : ?>
                                                                <a href="#" onclick="return confirm('Maaf anda belum login');" class="btn btn-primary font-weight-bolder mr-2"><span>DAFTAR</span></a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/Psarpraskwu/ltub/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">DAFTAR</a>
                                                            <?php endif; ?>
                                                        <?php } elseif ($key['status_selesai'] == 2) { ?>
                                                            <a class="tutup" href="#" class="btn btn-light-info font-weight-bolder mr-2">BERJALAN</a>
                                                        <?php } elseif ($key['status_selesai'] == 3) { ?>
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            <?php if (!$this->session->userdata('email')) : ?>
                                                                <a href="#" onclick="return confirm('Maaf anda belum login');" class="btn btn-primary font-weight-bolder mr-2"><span>DAFTAR</span></a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/Psarpraskwu/duta_pancasila/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">DAFTAR</a>
                                                            <?php endif; ?>
                                                        <?php } elseif ($key['status_selesai'] == 2) { ?>
                                                            <a class="tutup" href="#" class="btn btn-light-info font-weight-bolder mr-2">BERJALAN</a>
                                                        <?php } elseif ($key['status_selesai'] == 3) { ?>
