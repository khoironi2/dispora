        ...
        $(".btn-pelopor").click(function() {
            ...
            if (nama.length == "") {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>datacenter/4bursa/kepramukaan/daftarldk",
                    type: "POST",
                    data: {
                        "periode": periode,
                        "nama": nama,
                    ...
                    success: function(response) {
                        ...
                        if (response == "success") {
                            Swal.fire({
                                ...
                                .then(function() {
                                    window.location.href = "<?php echo base_url('datacenter/4bursa/kepramukaan/ldk/' . $getBursaID['id_bursa_kegiatan']) ?>";
                                });
