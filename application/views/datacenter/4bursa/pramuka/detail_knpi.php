                    ...
                    <div class="col-md-9">
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th class="pl-0 font-weight-bold text-muted text-uppercase">Nama Komite</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="font-weight-boldest font-size-lg">
                                        <td class="pl-0 pt-7"><input type="text" name="nama_komite" id="nama_komite" class="form-control form-control-lg form-control-solid"></td>
...
<script>
    $(document).ready(function() {
        ...
        $(".btn-pelopor").click(function() {
            ...
            var nama_komite = $("#nama_komite").val();
            ...
            if (nama.length == "") {
            ...
            } else if (nama_komite.length == "") {
                Swal.fire({
                    type: 'warning',
                    title: 'Oops...',
                    text: 'Nama Komite masih kosong !'
                });
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>datacenter/4bursa/kepramukaan/daftarknpi",
                    type: "POST",
                    data: {
                        "periode": periode,
                        "nama": nama,
                    ...
                    success: function(response) {
                        ...
                        if (response == "success") {
                            Swal.fire({
                                ...
                                .then(function() {
                                    window.location.href = "<?php echo base_url('datacenter/4bursa/kepramukaan/knpi/' . $getBursaID['id_bursa_kegiatan']) ?>";
                                });
