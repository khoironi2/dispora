    ...
    <div class="container">
        ...
        <div class="card card-custom overflow-hidden">
            <div class="card-body p-0">
                <!-- begin: Invoice-->
                <!-- <form action="<?= base_url('datacenter/4bursa/kepramukaan/daftarevaluasi') ?>" method="POST"> -->
                    ...
                    <div class="col-md-9">
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th class="pl-0 font-weight-bold text-muted text-uppercase">saran</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="font-weight-boldest font-size-lg">
                                        <td class="pl-0 pt-7"><input type="text" name="saran" id="saran" class="form-control form-control-lg "></td>
                                    </tr>
                                </tbody>
                            </table>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th class="pl-0 font-weight-bold text-muted text-uppercase">Rate</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="font-weight-boldest font-size-lg">
                                        <td>
                                            <select name="rating" id="rating" class="form-control form-control-lg">
...
<script>
    $(document).ready(function() {
        ...
        $(".btn-pelopor").click(function() {
            ...
            if (nama.length == "") {
            ...
            } else if (saran.length == "") {
                Swal.fire({
                    type: 'warning',
                    title: 'Oops...',
                    text: 'Saran masih kosong  !'
                });
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>datacenter/4bursa/kepramukaan/daftarevaluasi",
                    type: "POST",
                    data: {
                        "periode": periode,
                        "nama": nama,
                    ...
                    success: function(response) {
                        ...
                        if (response == "success") {
                            Swal.fire({
                                ...
                                .then(function() {
                                    window.location.href = "<?php echo base_url('datacenter/4bursa/kepramukaan/evaluasi/' . $getBursaID['id_bursa_kegiatan']) ?>";
                                });
