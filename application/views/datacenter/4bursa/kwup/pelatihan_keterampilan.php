        ...
        $(".btn-paskib").click(function() {
            ...
            if (paskib_nama.length == "") {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>datacenter/4bursa/Psarpraskwu/daftarpelatihan_keterampilan",
                    type: "POST",
                    data: {
                        "periode": periode,
                    ...
                    success: function(response) {
                        ...
                        if (response == "success") {
                            Swal.fire({
                                ...
                                .then(function() {
                                    window.location.href = "<?php echo base_url('datacenter/4bursa/Psarpraskwu/pelatihan_keterampilan/' . $getpaskibdepan['id_bursa_kegiatan']) ?>";
                                });
