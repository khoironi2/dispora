                    ...
                    <div class="col-md-9">
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th class="pl-0 font-weight-bold text-muted text-uppercase">Judul Karya</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="font-weight-boldest font-size-lg">
                                        <td class="pl-0 pt-7">
                                            <input type="text" name="judul_karya" id="judul_karya" class="form-control form-control-lg">
                                        </td>
                                    </tr>
                                    <thead>
                                        <tr>
                                            <th class="pl-0 font-weight-bold text-muted text-uppercase">Deskripsi Karya</th>
                                        </tr>
                                    </thead>
                                <tbody>
                                    <tr class="font-weight-boldest font-size-lg">
                                        <td class="pl-0 pt-7">
                                            <textarea name="deskripsi_karya" id="deskripsi_karya" cols="30" rows="3" class="form-control form-control-lg "></textarea>
                                        </td>
                                    </tr>
                                    <thead>
                                        <tr>
                                            <th class="pl-0 font-weight-bold text-muted text-uppercase">Link Video on Youtube</th>
                                        </tr>
                                    </thead>
                                <tbody>
                                    <tr class="font-weight-boldest font-size-lg">
                                        <td class="pl-0 pt-7">
                                            <textarea name="link_video_karya" id="link_video_karya" cols="30" rows="3" class="form-control form-control-lg "></textarea>
                                        </td>
                                    </tr>
...
<script>
    $(document).ready(function() {
        ...
        $(".btn-paskib").click(function() {
            ...
            var judul_karya = $("#judul_karya").val();
            var deskripsi_karya = $("#deskripsi_karya").val();
            var link_video_karya = $("#link_video_karya").val();
            ...
            if (paskib_nama.length == "") {
            ...
            } else if (judul_karya.length == "") {

                Swal.fire({
                    type: 'warning',
                    title: 'Oops...',
                    text: 'Judul masih kosong !'
                });

            } else if (deskripsi_karya.length == "") {
            ...
            } else if (link_video_karya.length == "") {

                Swal.fire({
                    type: 'warning',
                    title: 'Oops...',
                    text: 'Link Video masih kosong !'
                });
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>datacenter/4bursa/Psarpraskwu/daftargelarkarya",
                    type: "POST",
                    data: {
                        "periode": periode,
                        "judul_karya": judul_karya,
                        "deskripsi_karya": deskripsi_karya,
                        "link_video_karya": link_video_karya,
                    ...
                    success: function(response) {
                        ...
                        if (response == "success") {
                            Swal.fire({
                                ...
                                .then(function() {
                                    window.location.href = "<?php echo base_url('datacenter/4bursa/Psarpraskwu/gelarkarya/' . $getpaskibdepan['id_bursa_kegiatan']) ?>";
                                });
