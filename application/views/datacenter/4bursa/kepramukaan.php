                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_7_2" role="tabpanel" aria-labelledby="kt_tab_pane_7_2">
                                <div class="row pt-5 bg-light-primary">
                                    <?php $no = 1;
                                    foreach ($getketerampilan as $key) : ?>
                                        <div class="col-xxl-3 col-xl-6 col-md-6 col-sm-6">
                                            <!--begin::Card-->
                                            <div class="card card-custom gutter-b card-stretch">
                                                <!--begin::Body-->
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            <?php if (!$this->session->userdata('email')) : ?>
                                                                <a href="#" onclick="return confirm('Maaf anda belum login');" class="btn btn-primary font-weight-bolder mr-2"><span>DAFTAR</span></a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/kepramukaan/keterampilan_kepramukaan/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">DAFTAR</a>
                                                            <?php endif; ?>
                                                        <?php } elseif ($key['status_selesai'] == 2) { ?>
                                                            <a class="tutup" href="#" class="btn btn-light-info font-weight-bolder mr-2">BERJALAN</a>
                                                        <?php } elseif ($key['status_selesai'] == 3) { ?>
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            <?php if (!$this->session->userdata('email')) : ?>
                                                                <a href="#" onclick="return confirm('Maaf anda belum login');" class="btn btn-primary font-weight-bolder mr-2"><span>DAFTAR</span></a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/kepramukaan/ldk/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">DAFTAR</a>
                                                            <?php endif; ?>
                                                        <?php } elseif ($key['status_selesai'] == 2) { ?>
                                                            <a class="tutup" href="#" class="btn btn-light-info font-weight-bolder mr-2">BERJALAN</a>
                                                        <?php } elseif ($key['status_selesai'] == 3) { ?>
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_7_5" role="tabpanel" aria-labelledby="kt_tab_pane_7_3">
                                <div class="row pt-5 bg-light-primary">
                                    <?php $no = 1;
                                    foreach ($getrevitalisasi as $key) : ?>
                                        <div class="col-xxl-3 col-xl-6 col-md-6 col-sm-6">
                                            <!--begin::Card-->
                                            <div class="card card-custom gutter-b card-stretch">
                                                <!--begin::Body-->
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            <?php if (!$this->session->userdata('email')) : ?>
                                                                <a href="#" onclick="return confirm('Maaf anda belum login');" class="btn btn-primary font-weight-bolder mr-2"><span>DAFTAR</span></a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/kepramukaan/revitalisasi/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">DAFTAR</a>
                                                            <?php endif; ?>
                                                        <?php } elseif ($key['status_selesai'] == 2) { ?>
                                                            <a class="tutup" href="#" class="btn btn-light-info font-weight-bolder mr-2">BERJALAN</a>
                                                        <?php } elseif ($key['status_selesai'] == 3) { ?>
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            <?php if (!$this->session->userdata('email')) : ?>
                                                                <a href="#" onclick="return confirm('Maaf anda belum login');" class="btn btn-primary font-weight-bolder mr-2"><span>DAFTAR</span></a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/kepramukaan/evaluasi/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">Beri Penilaian</a>
                                                            <?php endif; ?>
                                                        <?php } elseif ($key['status_selesai'] == 2) { ?>
                                                            <a class="tutup" href="#" class="btn btn-light-info font-weight-bolder mr-2">BERJALAN</a>
                                                        <?php } elseif ($key['status_selesai'] == 3) { ?>
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_7_7" role="tabpanel" aria-labelledby="kt_tab_pane_7_3">
                                <div class="row pt-5 bg-light-primary">
                                    <?php $no = 1;
                                    foreach ($getperijinan as $key) : ?>
                                        <div class="col-xxl-3 col-xl-6 col-md-6 col-sm-6">
                                            <!--begin::Card-->
                                            <div class="card card-custom gutter-b card-stretch">
                                                <!--begin::Body-->
                                                    ...
                                                    <div class="pt-2">
                                                        <?php if ($key['status_selesai'] == 1) { ?>
                                                            <?php if (!$this->session->userdata('email')) : ?>
                                                                <a href="#" onclick="return confirm('Maaf anda belum login');" class="btn btn-primary font-weight-bolder mr-2"><span>DAFTAR</span></a>
                                                            <?php else : ?>
                                                                <a href="<?= base_url('datacenter/4bursa/kepramukaan/perijinan/' . $key['id_bursa_kegiatan']) ?>" class="btn btn-primary font-weight-bolder mr-2">DAFTAR</a>
                                                            <?php endif; ?>
                                                        <?php } elseif ($key['status_selesai'] == 2) { ?>
                                                            <a class="tutup" href="#" class="btn btn-light-info font-weight-bolder mr-2">BERJALAN</a>
                                                        <?php } elseif ($key['status_selesai'] == 3) { ?>
