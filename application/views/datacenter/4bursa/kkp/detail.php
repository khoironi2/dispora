                        ...
                        <div class="d-flex justify-content-between">
                            <?php if ($getpaskibdepan['status_selesai'] == 1) { ?>
                                ...
                                <?php else : ?>
                                    ...
                                    <?php if ($getpaskibrakaMy['id_user_pemuda'] == $user['id_user']) { ?>
        ...
        $(".btn-paskib").click(function() {
            ...
            if (paskib_nama.length == "") {
                ...
                $.ajax({
                    ...
                    data: {
                        "periode": periode,
                        "paskib_nama": paskib_nama,
                        "paskib_institusi_asal": paskib_institusi_asal,
                        "paskib_alamat_ktp": paskib_alamat_ktp,
                        "paskib_alamat_domisili": paskib_alamat_domisili,
                        "paskib_kabupaten": paskib_kabupaten,
                    ...
                    success: function(response) {
                        ...
                        if (response == "success") {
                            Swal.fire({
                                ...
                                .then(function() {
                                    window.location.href = "<?php echo base_url('datacenter/4bursa/kkp/paskib/' . $getpaskibdepan['id_bursa_kegiatan']) ?>";
                                });
