        ...
        $(".btn-pelopor").click(function() {
            ...
            if (nama.length == "") {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>datacenter/4bursa/kkp/daftarduta_pancasila",
                    type: "POST",
                    data: {
                        "periode": periode,
                        "nama": nama,
                    ...
                    success: function(response) {
                        ...
                        if (response == "success") {
                            Swal.fire({
                                ...
                                .then(function() {
                                    window.location.href = "<?php echo base_url('datacenter/4bursa/kkp/duta_pancasila/' . $getBursaID['id_bursa_kegiatan']) ?>";
                                });
