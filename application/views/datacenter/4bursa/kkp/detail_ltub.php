...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div>
                <!-- <form action="<?= base_url('datacenter/4bursa/kkp/tambahkelompokltub') ?>" method="POST"> -->
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" hidden name="id_pendaftar" id="id_pendaftar" value="<?= $getMy['id_pendaftar_lomba_tata_upacara_bendera'] ?>" class="form-control form-control-lg form-control-solid" required>
                    </div>
                </div>
        ...
        $(".btn-pelopor").click(function() {
            ...
            if (nama.length == "") {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>datacenter/4bursa/kkp/daftarltub",
                    type: "POST",
                    data: {
                        "periode": periode,
                        "nama": nama,
                    ...
                    success: function(response) {
                        ...
                        if (response == "success") {
                            Swal.fire({
                                ...
                                .then(function() {
                                    window.location.href = "<?php echo base_url('datacenter/4bursa/kkp/ltub/' . $getBursaID['id_bursa_kegiatan']) ?>";
                                });
        ...
        $(".save-anggota").click(function() {
            ...
            if (nama_anggota.length == "") {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url() ?>datacenter/4bursa/kkp/tambahkelompokltub",
                    type: "POST",
                    data: {
