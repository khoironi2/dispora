            ...
            <div class="modal-body py-0">
                ...
                <div class="profile modal-gx-n">
                    ...
                    <div class="profile-body">
                        ...
                        <p>
                            <?php
                            $waktu_awal        = strtotime($user['time_login_user']);
                            ...
                            if ($diff < 60) {
                                ...
                                echo 'login ' .  floor($menit) . ' menit yang lalu';
                            } elseif ($diff > 3600 && $diff <= 86400) {
                                echo 'login ' . floor($jam) .  ' jam yang lalu ';
                            } elseif ($diff > 86400) {
                                echo 'login ' . floor($hari) . 'hari yang lalu';
                            }
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                        <a href="<?= base_url('sign/logout') ?>" class="text-danger">Logout</a>
                    </li>
                </ul>
                <!-- List -->
            </div>
