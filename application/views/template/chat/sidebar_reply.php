...
<!-- <script type="text/javascript">
    ...
    function update() {
        $.ajax({
            type: 'POST',
            url: "<?= base_url('disc/beranda/load_in_reply') ?>",
            cache: false,
            success: function(data) {
                $("#live_data_in_reply").html(data);
            }
        });

        $.ajax({
            type: 'POST',
            url: "<?= base_url('disc/beranda/loadfriend_in_reply') ?>",
            cache: false,
            success: function(data) {
                $("#live_friend_in_reply").html(data);
            }
        });

        $.ajax({
            type: 'POST',
            url: "<?= base_url('disc/beranda/loadnotifikasi_in_reply') ?>",
            cache: false,
            success: function(data) {
                $("#notifikasi_in_reply").html(data);
            }
        });
