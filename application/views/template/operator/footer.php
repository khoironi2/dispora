    ...
    <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <?php foreach ($pengaturan as $key) : ?>
            <div class="text-dark order-2 order-md-1">
                ...
                <a href="http://keenthemes.com/keen" target="_blank" class="text-dark-75 text-hover-primary"><?= $key['nama_footer'] ?></a>
            </div>
        <?php endforeach ?>
        <!--end::Copyright-->
        <!--begin::Nav-->
...
<div id="kt_quick_user" class="offcanvas offcanvas-left p-10">
    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <!--begin::Item-->
            <a href="<?= base_url($user['level_user'] . '/account') ?>" class="navi-item">
                <div class="navi-link">
            ...
            <!--begin::Item-->
            <?php if ($user['level_user'] == 'pemuda') { ?>
                <a href="<?= base_url($user['level_user'] . '/dashboard') ?>" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                ...
                <a href="<?= base_url($user['level_user'] . '/prestasi') ?>" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                        ...
                        <div class="navi-text">
                            <div class="font-weight-bold">Prestasi</div>
                        </div>
                        <!-- <div class="text-muted">Logs and notifications</div> -->
                    </div>
                </a>
                <a href="<?= base_url('disc/beranda') ?>" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                        ...
                        <div class="navi-text">
                            <div class="font-weight-bold">Forum</div>
                            <div class="text-muted">Forum Diskusi Komunikasi Sosial DISPORA</div>
                        </div>
                    </div>
                </a>
            <?php } elseif ($user['level_user'] == 'operator') { ?>
                <a href="<?= base_url('disc/beranda') ?>" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
            ...
            <?php } elseif ($user['level_user'] == 'pimpinan') { ?>
                <a href="<?= base_url('disc/beranda') ?>" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
            ...
            <?php } elseif ($user['level_user'] == 'admin') { ?>
                <a href="<?= base_url('disc/beranda') ?>" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#provinsi").change(function() {
            var url = "<?php echo site_url('operator/account/kabupaten'); ?>/" + $(this).val();
            $('#kabupaten').load(url);
            return false;
        });
        $("#kabupaten").change(function() {
            var url = "<?php echo site_url('operator/account/kecamatan'); ?>/" + $(this).val();
            $('#kecamatan').load(url);
            return false;
        })
        $("#kecamatan").change(function() {
            var url = "<?php echo site_url('operator/account/kelurahan'); ?>/" + $(this).val();
            $('#kelurahan').load(url);
            return false;
        })
    });
