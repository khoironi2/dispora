...
<script type="text/javascript">
    $(document).ready(function() {
        $("#provinsi").change(function() {
            var url = "<?php echo site_url('pimpinan/account/kabupaten'); ?>/" + $(this).val();
            $('#kabupaten').load(url);
            return false;
        });
        $("#kabupaten").change(function() {
            var url = "<?php echo site_url('pimpinan/account/kecamatan'); ?>/" + $(this).val();
            $('#kecamatan').load(url);
            return false;
        })
        $("#kecamatan").change(function() {
            var url = "<?php echo site_url('pimpinan/account/kelurahan'); ?>/" + $(this).val();
            $('#kelurahan').load(url);
            return false;
        })
    });
