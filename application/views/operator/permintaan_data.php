        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="login-form login-signup">
                    <!--begin::Form-->
                    <form action="<?= base_url('operator/permintaan_data/save') ?>" method="POST" class="form" enctype="multipart/form-data">
                        <!--begin::Title-->
                        <!--end::Title-->
                        <!--begin::Form group-->
...
<?php foreach ($get as $key) : ?>
    ...
    <div class="modal fade" id="edit<?= $key['id_permintaan_data'] ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Kirim Data Ke <?= $key['pimpinan'] ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i aria-hidden="true" class="ki ki-close"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="login-form login-signup">
                        <!--begin::Form-->
                        <form action="<?= base_url('operator/permintaan_data/update') ?>" method="POST" class="form" enctype="multipart/form-data">

                            <div class="row">
                                <label for="exampleSelectl">Keterangan</label>
                                <textarea readonly class="form-control form-control-solid h-auto p-6 rounded-lg font-size-h6 name=" keterangan_peminta" id="keterangan_peminta"><?= $key['keterangan_peminta'] ?></textarea>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="file" name="file_permintaan_data" class="form-control form-control-solid h-auto p-6 rounded-lg font-size-h6" />
                                </div>
                                <div class="col">
                                    <label for="exampleSelectl">Nama File</label>
                                    <input type="text" name="nama_file" value="<?= $key['nama_file'] ?>" class="form-control form-control-solid h-auto p-6 rounded-lg font-size-h6" required />
                                </div>
                            </div>
                            <div class="row">
                                <label for="exampleSelectl">Ketik pesan disini</label>
                                <textarea class="form-control  h-auto p-6 rounded-lg font-size-h6" name="keterangan_pengirim" id="keterangan_pengirim"><?= $key['keterangan_pengirim'] ?></textarea>
                            </div>
...
<?php foreach ($get as $key) : ?>
    ...
    <div class="modal fade" id="delete<?= $key['id_permintaan_data'] ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form action="<?= base_url('operator/kreatifitas_kelembagaan_pemuda/delete/' . $key['id_permintaan_data']) ?>" method="POST">
                <div class="modal-content">
                    <div class="modal-header">
