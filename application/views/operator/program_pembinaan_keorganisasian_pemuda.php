                    ...
                    <tbody>
                        ...
                        foreach ($get as $key) : ?>
                            <tr>
                                ...
                                <td><?= $key['periode'] ?></td>
                                <td>
                                    <a data-toggle="modal" data-target="#edit<?= $key['id_program_keorganisasian'] ?>">
                                        <span style="font-size: 3em; color: red;">
                                            <i class="far fa-edit"></i>
                                        </span>
                                    </a>
                                    <a data-toggle="modal" data-target="#delete<?= $key['id_program_keorganisasian'] ?>">
                                        <span style="font-size: 3em; color: red;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="login-form login-signup">
                    <!--begin::Form-->
                    <form action="<?= base_url('operator/program_pembinaan_keorganisasian_pemuda/save') ?>" method="POST" class="form">
                        <!--begin::Title-->
                        <!--end::Title-->
                        <!--begin::Form group-->
...
<?php foreach ($get as $key) : ?>
    <!-- Modal edit-->
    <div class="modal fade" id="edit<?= $key['id_program_keorganisasian'] ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="login-form login-signup">
                        <!--begin::Form-->
                        <form action="<?= base_url('operator/program_pembinaan_keorganisasian_pemuda/update') ?>" method="POST" class="form">
                            <!--begin::Title-->
                            <!--end::Title-->
                            <!--begin::Form group-->
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-solid h-auto p-6 rounded-lg font-size-h6" type="text" placeholder="nama program" hidden value="<?= $key['id_program_keorganisasian'] ?>" name="id_program_keorganisasian" id="id_program_keorganisasian" autocomplete="off" />
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
...
<?php foreach ($get as $key) : ?>
    <!-- Modal delete-->
    <div class="modal fade" id="delete<?= $key['id_program_keorganisasian'] ?>" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form action="<?= base_url('operator/program_pembinaan_keorganisasian_pemuda/delete/' . $key['id_program_keorganisasian']) ?>" method="POST">
                <div class="modal-content">
                    <div class="modal-header">
