                    ...
                    <tbody>
                        ...
                        foreach ($getall as $key) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php if ($key['status_lulus'] == 1) { ?>
                                        <a href="<?= base_url('operator/publikasi/berjalan/keterampilan_kepramukaan/setuju/' . $key['id_pendaftar_pelatihan_keterampilan_kepramukaan']) ?>"><span class="badge rounded-pill bg-light-success">SETUJUI</span></a>
                                    <?php } elseif ($key['status_lulus'] == 2) { ?>
                                        <a href="<?= base_url('operator/publikasi/berjalan/keterampilan_kepramukaan/batalkan/' . $key['id_pendaftar_pelatihan_keterampilan_kepramukaan']) ?>"><span class="badge rounded-pill bg-light-danger">BATALKAN</span></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php endforeach ?>
