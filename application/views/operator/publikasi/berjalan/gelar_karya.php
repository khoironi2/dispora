                    ...
                    <tbody>
                        ...
                        foreach ($getall as $key) : ?>
                            <tr>
                                ...
                                <td><?= $key['user']  ?></td>
                                <td><?= $key['judul_karya']  ?></td>
                                <td><?= $key['deskripsi_karya']  ?></td>
                                <td><?php if (empty($key['link_video_karya'])) { ?>
                                        <span class="text-danger"> kosong</span>
                                    <?php } else { ?>
                                        <a target="_blank" href="<?= $key['link_video_karya'] ?>"><?= $key['link_video_karya'] ?></a>
                                    <?php } ?>
                                </td>
                                ...
                                <td>
                                    <?php if ($key['status_lulus'] == 1) { ?>
                                        <a href="<?= base_url('operator/publikasi/berjalan/gelar_karya/setuju/' . $key['id_pendaftar_gelar_karya_pemuda']) ?>"><span class="badge rounded-pill bg-light-success">SETUJUI</span></a>
                                    <?php } elseif ($key['status_lulus'] == 2) { ?>
                                        <a href="<?= base_url('operator/publikasi/berjalan/gelar_karya/batalkan/' . $key['id_pendaftar_gelar_karya_pemuda']) ?>"><span class="badge rounded-pill bg-light-danger">BATALKAN</span></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php endforeach ?>
