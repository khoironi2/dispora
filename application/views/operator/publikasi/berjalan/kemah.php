                    ...
                    <tbody>
                        ...
                        foreach ($getall as $key) : ?>
                            <tr>
                                ...
                                <td><?= $key['user']  ?></td>
                                <td>
                                    <a href="<?= base_url('operator/publikasi/berjalan/kemah/anggota/' . $key['id_pendaftar_kemah_bakti_pramuka']) ?>">Anggota</a>
                                </td>
                                ...
                                <td>
                                    <?php if ($key['status_lulus'] == 1) { ?>
                                        <a href="<?= base_url('operator/publikasi/berjalan/kemah/setuju/' . $key['id_pendaftar_kemah_bakti_pramuka']) ?>"><span class="badge rounded-pill bg-light-success">SETUJUI</span></a>
                                    <?php } elseif ($key['status_lulus'] == 2) { ?>
                                        <a href="<?= base_url('operator/publikasi/berjalan/kemah/batalkan/' . $key['id_pendaftar_kemah_bakti_pramuka']) ?>"><span class="badge rounded-pill bg-light-danger">BATALKAN</span></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php endforeach ?>
