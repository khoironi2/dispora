                    ...
                    <tbody>
                        ...
                        foreach ($getall as $key) : ?>
                            <tr>
                                ...
                                <td><?= $key['user']  ?></td>
                                <td><?php if (empty($key['nama_usaha'])) { ?>
                                ...
                                <td>
                                    <?php if ($key['status_lulus'] == 1) { ?>
                                        <a href="<?= base_url('operator/publikasi/berjalan/kewirausahaan/setuju/' . $key['id_pendaftar_seleksi_kewirausahaan_muda_pemula']) ?>"><span class="badge rounded-pill bg-light-success">SETUJUI</span></a>
                                    <?php } elseif ($key['status_lulus'] == 2) { ?>
                                        <a href="<?= base_url('operator/publikasi/berjalan/kewirausahaan/batalkan/' . $key['id_pendaftar_seleksi_kewirausahaan_muda_pemula']) ?>"><span class="badge rounded-pill bg-light-danger">BATALKAN</span></a>
                                    <?php } ?>
                                </td>
                            </tr>
                        <?php endforeach ?>
