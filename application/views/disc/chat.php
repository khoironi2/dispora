                                ...
                                <div class="message-body">
                                    <div class="message-content">
                                        <div class="message-text">
                                            <p>Hzzzey, Marshall! How are you? Can you please change the color theme of the website to pink and purple?</p>
                                        </div>
                                ...
                                <div class="message-body">
                                    <div class="message-content">
                                        <div class="message-gallery">
                                            <div class="row gx-3">
                                                <div class="col">
                                                    <img class="img-fluid rounded" src="<?= base_url('assets/chat/') ?>/img/chat/1.jpg" data-action="zoom" alt="">
                                                </div>
                                                <div class="col">
                                                    <img class="img-fluid rounded" src="<?= base_url('assets/chat/') ?>/img/chat/2.jpg" data-action="zoom" alt="">
                                                </div>
                                                <div class="col">
                                                    <img class="img-fluid rounded" src="<?= base_url('assets/chat/') ?>/img/chat/3.jpg" data-action="zoom" alt="">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="message message-out">
                            ...
                            <div class="message-inner">
                                <div class="message-body">
                                    <div class="message-content">
                                        <div class="message-text">
                                            <p>Heyxx, Marshall! How are you? Can you please change the color theme of the website to pink and purple? 😂</p>
                                        </div>
