...
<body id="kt_body" class="header-mobile-fixed subheader-enabled aside-enabled aside-fixed aside-secondary-enabled page-loading">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
            <!--begin::Aside-->
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #2F85BE;">
                <!--begin::Aside Top-->
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    ...
                    <!--end::Aside header-->
                    <!--begin::Aside title-->
                    <h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg text-white">Dinas Olahraga dan Kepemudaan
                        <br />Provinsi &amp; Banten
                    </h3>
                    <!--end::Aside title-->
                </div>
                                ...
                                <div class="d-flex align-items-center p-5">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="text-dark-75">
                                            Pusat data yang menampung inforsmasi atlet hingga fasilitas olahraga Dinas olahraga dan Kepemudaan Provinsi Banten.
                                        </div>
            ...
            <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center p-5">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="text-dark-75">
                                            Halaman yang menampilkan informasi di peruntukan pada pengguna admin untuk pengelolaan situs Dinas Olahraga dan Kepemudaan Provinsi Banten.
                                        </div>
                ...
                <div class="font-size-h6 font-weight-bolder order-2 order-md-1 py-2 py-md-0">
                    ...
                    <a target="_blank" class="text-dark-50 text-hover-primary">DISPORA Provinsi Banten</a>
                </div>
                <!--end::Content footer-->
            </div>
            <!--end::Content-->
    ...
    <script src="<?= base_url('assets/') ?>theme/demo5/dist/assets/js/pages/custom/login/login1036.js?v=2.1.1"></script>
    <!--end::Page Scripts-->
</body>
<!--end::Body-->
