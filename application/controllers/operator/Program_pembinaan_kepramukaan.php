...
class Program_pembinaan_kepramukaan extends CI_Controller
{
    ...
    public function index()
    {
        $data = [
            ...
            'tab' => 'tab1',
            'page' => 'Data Program Pembinaan Kepramukaan',
            'user' => $this->db->get_where('tbl_user', ['email' => $this->session->userdata('email')])->row_array(),
            'pengaturan' => $this->Pengaturan_model->get(),
            'get' => $this->Program_dan_pembinaan_kepramukaan_model->get(),
        ];
        $this->load->view('template/operator/header', $data);
        $this->load->view('template/operator/sidebar');
        $this->load->view('operator/program_pembinaan_kepramukaan', $data);
    ...
    public function save()
    {
        ...
        $insert = $this->Program_dan_pembinaan_kepramukaan_model->insert("tbl_program_dan_pembinaan_kepramukaan", $data);

        if ($insert) {
            // echo "success";
            $this->session->set_flashdata('success_login', 'Sukses, Anda telah terdaftar.');
            redirect('operator/program_pembinaan_kepramukaan');
        } else {
    ...
    public function update()
    {
        ...
        $id = $this->input->post('id_program_kepramukaan');
        $insert = $this->Program_dan_pembinaan_kepramukaan_model->update($id, $data);
    ...
    {
        $data['id_program_kepramukaan'] = $this->Program_dan_pembinaan_kepramukaan_model->delete($id);
