...
class Gelar_karya_pemuda_model extends CI_Model
{
    ...
    public function get()
    {
        ...
        $this->db->where('jenis.nama_jenis_kegiatan', 'GELAR KARYA PEMUDA');
    ...
    public function getpublik()
    {
        ...
        ');
        $this->db->from('tbl_pendaftar_gelar_karya_pemuda as a');
        ...
        $this->db->where('e.nama_jenis_kegiatan', 'GELAR KARYA PEMUDA');
        $this->db->order_by('a.id_pendaftar_gelar_karya_pemuda', 'DESC');
        $result = $this->db->get();
    ...
    public function getMy($id)
    {
        ...
        $this->db->where('d.nama_jenis_kegiatan', 'GELAR KARYA PEMUDA');
        $this->db->group_by('a.id_pendaftar_gelar_karya_pemuda');
        $result = $this->db->get();
    ...
    {
        $this->db->where('id_pendaftar_gelar_karya_pemuda', $id);
        $this->db->update('tbl_pendaftar_gelar_karya_pemuda', $data);
    ...
    {
        $this->db->where('id_pendaftar_gelar_karya_pemuda', $id);
        $this->db->delete('tbl_pendaftar_gelar_karya_pemuda');
