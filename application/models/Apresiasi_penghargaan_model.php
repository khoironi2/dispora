...
class Apresiasi_penghargaan_model extends CI_Model
{
    ...
    public function get()
    {
        ...
        $this->db->where('jenis.nama_jenis_kegiatan', 'APRESIASI DAN PENGHARGAAN');
    ...
    public function getpublik()
    {
        ...
        ');
        $this->db->from('tbl_pendaftar_apresiasi_dan_penghargaan as a');
        ...
        $this->db->where('e.nama_jenis_kegiatan', 'APRESIASI DAN PENGHARGAAN');
        $this->db->order_by('a.id_pendaftar_apresiasi_dan_penghargaan', 'DESC');
        $result = $this->db->get();
    ...
    public function getMy($id)
    {
        ...
        $this->db->where('d.nama_jenis_kegiatan', 'APRESIASI DAN PENGHARGAAN');
        $this->db->group_by('a.id_pendaftar_apresiasi_dan_penghargaan');
        $result = $this->db->get();
    ...
    {
        $this->db->where('id_pendaftar_apresiasi_dan_penghargaan', $id);
        $this->db->update('tbl_pendaftar_apresiasi_dan_penghargaan', $data);
    ...
    {
        $this->db->where('id_pendaftar_apresiasi_dan_penghargaan', $id);
        $this->db->delete('tbl_pendaftar_apresiasi_dan_penghargaan');
