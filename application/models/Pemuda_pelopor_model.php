...
class Pemuda_pelopor_model extends CI_Model
{
    ...
    public function getpublik()
    {
        ...
        tbl_pendaftar_pemuda_pelopor.periode as periode_pemuda_pelopor
        ');
        ...
        $this->db->where('tbl_pendaftar_pemuda_pelopor.status_lulus', '2');
        $this->db->where('jenis.nama_jenis_kegiatan', 'PEMUDA PELOPOR');
        $this->db->order_by('tbl_pendaftar_pemuda_pelopor.id_pendaftar_pemuda_pelopor', 'DESC');
        $result = $this->db->get();
    ...
    {
        $this->db->where('id_pendaftar_pemuda_pelopor', $id);
        $this->db->update('tbl_pendaftar_pemuda_pelopor', $data);
    ...
    {
        $this->db->where('id_pendaftar_pemuda_pelopor', $id);
        $this->db->delete('tbl_pendaftar_pemuda_pelopor');
