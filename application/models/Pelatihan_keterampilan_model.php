...
class Pelatihan_keterampilan_model extends CI_Model
{
    ...
    public function get()
    {
        ...
        $this->db->where('jenis.nama_jenis_kegiatan', 'PELATIHAN KETERAMPILAN PEMUDA');
    ...
    public function getpublik()
    {
        ...
        ');
        $this->db->from('tbl_pendaftar_pelatihan_keterampilan_pemuda as a');
        ...
        $this->db->where('e.nama_jenis_kegiatan', 'PELATIHAN KETERAMPILAN PEMUDA');
        $this->db->order_by('a.id_pendaftar_pelatihan_keterampilan_pemuda', 'DESC');
        $result = $this->db->get();
    ...
    public function getMy($id)
    {
        ...
        $this->db->where('d.nama_jenis_kegiatan', 'PELATIHAN KETERAMPILAN PEMUDA');
        $this->db->group_by('a.id_pendaftar_pelatihan_keterampilan_pemuda');
        $result = $this->db->get();
    ...
    {
        $this->db->where('id_pendaftar_pelatihan_keterampilan_pemuda', $id);
        $this->db->update('tbl_pendaftar_pelatihan_keterampilan_pemuda', $data);
    ...
    {
        $this->db->where('id_pendaftar_pelatihan_keterampilan_pemuda', $id);
        $this->db->delete('tbl_pendaftar_pelatihan_keterampilan_pemuda');
