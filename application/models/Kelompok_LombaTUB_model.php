...
class Kelompok_LombaTUB_model extends CI_Model
{
    public function getAll()
    {
        ...
        d.nama as kabupaten
        ');
        $this->db->from('tbl_anggota_kelompok_lomba_tata_upacara_bendera as a');
        $this->db->join('tbl_pendaftar_lomba_tata_upacara_bendera as b', 'b.id_pendaftar_lomba_tata_upacara_bendera=a.id_pendaftar', 'left');
        ...
        $this->db->where('f.nama_jenis_kegiatan', 'LOMBA TATA UPACARA BENDERA');
    ...
    public function update($id, $data)
    {
        ...
        $this->db->update('tbl_anggota_kelompok_lomba_tata_upacara_bendera', $data);
    ...
    {
        $this->db->where('id_anggota_kelompok ', $id);
        $this->db->delete('tbl_anggota_kelompok_lomba_tata_upacara_bendera');
